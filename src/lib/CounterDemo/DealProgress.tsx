            ...
            <CardContent>
                <div className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <Progress
                            value={
                                ((dealStages.indexOf(currentStage) + 1) /
                                    dealStages.length) *
                                100
                            }
                            className="h-2"
                            ...
                            <TooltipProvider>
                                <Tooltip>
                                    ...
                                    <TooltipContent className="max-w-xs">
                                        <p>
                                            Predictions based on deal qualification status and
                                            comparison with historical deals at the same stage
                                        </p>
                                        <a href="">
