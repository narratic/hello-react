...
export interface DealBreakerDialogProps {
    isOpen: boolean;
    onOpenChange: (open: boolean) => void;
    dealBreaker: string;
...
export function EditQuestionDialog({ isOpen, onOpenChange, data, onSave }: EditQuestionDialogProps) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>{data.questionIndex !== null ? "Edit Question" : "Add Question"}</DialogTitle>
                </DialogHeader>
        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent>
                ...
                <DialogFooter>
                    ...
                    <Button onClick={onSave} disabled={!dealBreaker.trim()}>
                        Save Deal Breaker
                    </Button>
                </DialogFooter>
            </DialogContent>
