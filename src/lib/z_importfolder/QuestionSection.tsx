          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent className="max-w-xs">
                <p>A qualification question to help assess this deal's fit and potential. Customize these questions to ensure they reflect the key criteria for advancing deals in your sales process.</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
        <div className="col-span-3 flex items-center gap-1">
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p>Labels give a quick summary of each question's focus, helping you navigate and understand key points faster.</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
          ...
          <div key={index} className="grid grid-cols-12 gap-4 items-center p-3 bg-slate-50 rounded-lg">
            ...
            <div className="col-span-2 flex items-center justify-end space-x-2">
              <Button
                variant="ghost"
                size="sm"
                onClick={() => onEdit(sectionKey, index)}
              >
