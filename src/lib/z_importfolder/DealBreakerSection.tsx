        ...
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent className="max-w-xs">
              <p>A critical factor that, if unmet, may prevent the deal from progressing. Use these to flag make-or-break criteria that should be carefully monitored throughout the sales process.</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
      </div>
